...
export const LIVE_FINALS_STAGE = 'Live Finals';
export const CONTEST_STAGES = [FINAL_TRIAL_STAGE, 'Stage 1', 'Stage 2', 'Stage 3', LIVE_FINALS_STAGE] as const;
export const ONLINE_CONTEST_STAGES = [FINAL_TRIAL_STAGE, 'Stage 1', 'Stage 2', 'Stage 3'] as const;
export const MAIN_CONTEST_STAGES = ['Stage 1', 'Stage 2', 'Stage 3', LIVE_FINALS_STAGE] as const;
